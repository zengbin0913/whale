...
CREATE TABLE whale_family(  
  ...
  fname VARCHAR(32) DEFAULT "衣物",          #商品名称
  kg TINYINT,	              #旧衣物的重量 1-->5到10kg  2-->10到20kg   3-->21到30kg   4-->30kg以上
	user_id INT
);
INSERT INTO whale_family VALUES(NULL,"衣物",1,1);
...
CREATE TABLE whale_order(
  ...
  oaddress  VARCHAR(128) DEFAULT "西藏",     #捐赠的地区 青海-西藏-贵州-甘肃-云南
  status TINYINT DEFAULT 1,             #订单状态   1-等待发货  2-运输中  3-已签收  4-已取消
  deliver_time BIGINT DEFAULT NULL,        #发货时间
  received_time BIGINT DEFAULT NULL,       #签收时间
  success_time BIGINT DEFAULT NULL,       #成功时间
	express VARCHAR(24) DEFAULT NULL       #物流单号
);
...
INSERT INTO whale_detail VALUES(NULL,"四川苟哇村一松寨当地小学活动",1566347870103,"admin","有一小段时间没有给大家更新活动信息了。今天小编给带来四川苟哇村一松寨的一个小心的捐赠反馈。这个小学只有几十个学生，大都是附近村里面的孩子，村上比较贫困，大部分的家庭都还是住在黄泥房子。本次的书包是白鲸鱼通过回收衣物所得款项购买，希望这份小小的心意能够给这些小孩子们带上一些温暖。因为一些原因，我们这次在这个小学的时间非常的有限，因为次日需要去这些孩子们的家庭中继续活动，届时可以看到这些孩子背后更多的情况。","030055851.jpg","https://www.52bjy.com/news/show-245.html");
INSERT INTO whale_detail VALUES(NULL,"白鲸鱼重聚青海玉树藏族自治州捐赠旧衣服",1566347870103,"admin","这次是我们第二次捐赠衣物给青海玉树藏族自治州了。感谢长沙一百穗对活动的支持。白鲸鱼自成立以来，一直秉承这环保和公益的理念，我们从未停止过对西部地区的关心和支持。孩子们开心的领取衣物，虽然是在一个没有房子的大草坪，而且当地气温还比较低，但是孩子们依然高兴。大家围城一个圈，席地而坐，均匀分发白鲸鱼旧衣服物资，感受来自五湖四海的满满的爱心。虽然反馈的照片不多，但是还是非常的感谢当地的志愿者帮助白鲸鱼分发衣物并且拍摄反馈。","01554215226381.jpg","https://www.52bjy.com/news/show-244.html");
INSERT INTO whale_detail VALUES(NULL,"旧衣公益新疆阿克苏白鲸鱼留下爱的足迹",1566347870103,"admin","白鲸鱼自上线以来，一直得到用户的青睐和支持，目前捐赠地区已经遍布了大部分西部地区，我们还在不断的开疆扩土，希望能够给更多的人带来温暖。虽然现在已经临近年底，但是对于白鲸鱼来说，还在忙碌者发挥自己的光和热，不停的捐赠更多衣物给有需要的地区。本次给您带来新疆阿克苏反馈。","014425411.jpg","https://www.52bjy.com/news/show-237.html");
INSERT INTO whale_detail VALUES(NULL,"白鲸鱼走访石家庄正定县贫困户",1566347870103,"admin","这个村子是当地有名的贫困村，人口不多，但是大部分家庭条件都不好，学校的学习环境也比较落后。非常感谢当地的爱心人士挨家挨户的登门，吧白鲸鱼的物资送到孩子门的手上。村里基本的青壮年都外出打工了，留在家里的基本都是留守儿童和老人家，这个也是很多中国农村的现状老人家的儿女常年在外地打工，很少回来照顾，老人家的生活也非常的节俭，节本家里没有什么好的衣物。","000752191.jpg","https://www.52bjy.com/news/show-253.html");
INSERT INTO whale_detail VALUES(NULL,"白鲸鱼会宁县翟家所镇塬坪希望小学行动",1566347870103,"admin","会宁县翟家所镇塬坪希望小学，学校前身为一所民办公助学校，创建于1945年。新中国成立后，学校校址迁至庙咀。1967年搬迁至张堡社，1978年改建为七年制。2003年，学校作为甘肃省政协的帮扶对象，对学校进行改建和扩建，2003年9月举行校舍竣工典礼以及学校挂牌仪式。从此，学校正式命名为“翟家所乡塬坪希望小学”。","1933127656714.jpg","https://www.52bjy.com/news/show-234.html");
